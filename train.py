...
def auto_eval(config, vocab, model_F, test_iters, global_step, temperature):
    ...
    ppl_neg = 9.9#evaluator.yelp_ppl(rev_output[0])
    ppl_pos = 9.9#evaluator.yelp_ppl(rev_output[1])
    ...
    with open(save_file, 'w') as fw:
        ...
        for idx in range(len(rev_output[0])):
            ...
            print('[enh ]', enhance_output[0][idx], file=fw)
        ...
        for idx in range(len(rev_output[1])):
            ...
            print('[enh ]', enhance_output[1][idx], file=fw)
